namespace Mediation
{
    ...
    {
        public const string REQUEST_MESSAGE_SERVER = "REQUEST_MESSAGE_SERVER";
        public const string REQUEST_MESSAGE_SERVER_RESPONSE = "REQUEST_MESSAGE_SERVER_RESPONSE";


        public const string REQUEST_VIEW_PROFILE = "REQUEST_VIEW_PROFILE";
        public const string REQUEST_VIEW_MESSENGER = "REQUEST_VIEW_MESSAGE_OBSERVER";
